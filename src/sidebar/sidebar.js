module.exports = {
  docs: [
    ...
    },
    {
      type: 'category',
      label: 'Tezos Basics',
      items: ['tezos-basics/introduction', 'tezos-basics/liquid-proof-of-stake', 'tezos-basics/governance-on-chain', 'tezos-basics/economics_and_reward', 'tezos-basics/exam'],
    },
    {
      type: 'category',
      label: 'Deploy a node',
