...
- **open_raffle** can only be called by the administrator. During this call, he sends the jackpot amount to the contract, defines a closing date, indicates the hash of the number of the winning ticket, and declares the raffle open.
