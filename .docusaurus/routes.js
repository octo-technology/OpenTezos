...
{
  path: '/smartpy/installation',
  component: ComponentCreator('/smartpy/installation','e5f'),
  exact: true,
},
{
  path: '/smartpy/write-contract-smartpy',
  component: ComponentCreator('/smartpy/write-contract-smartpy','758'),
  exact: true,
},
{
  path: '/tezos-basics',
