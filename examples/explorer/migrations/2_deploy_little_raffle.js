const LittleRaffle = artifacts.require("littleRaffle");
...
const initialStorage = {
    "contract_name": "Raffle smart contract with map",
    "admin": admin,
...
module.exports = deployer => {
    deployer.deploy(LittleRaffle, initialStorage).then(e => e.buyTicket([["unit"]], {amount: 1}))
};
